   ...
   |====DINOPOLY====|
    ...
    if (localStorage.getItem('mpEnabled') == '1') {
        ...
        div.innerHTML = `
            ...
            <p style="position: fixed;display: flex;margin: 0;width: 100%;justify-content: center;backdrop-filter: blur(6px);bottom: 0;">Due to inflation, actual prices may differ from displayed prices.</p>
